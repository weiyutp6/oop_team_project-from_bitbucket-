...
public class DateChooser extends JPanel {
    ...
    public static boolean isDate2AfterDate1(String date1, String date2) {
        Date thisDate = new Date(Integer.parseInt(date1.substring(0,3)), Integer.parseInt(date1.substring(4,5)), Integer.parseInt(date1.substring(6,7)));
        return thisDate.compareTo(new Date(Integer.parseInt(date2.substring(0, 3)), Integer.parseInt(date2.substring(4, 5)), Integer.parseInt(date2.substring(6, 7)))) <= 0;
    }
